...
CC              =  /home/m/kernel/toolchain/clang/host/linux-x86/clang-4639204/bin/clang
CPP		=  $(CC) -E
AR		=  $(CROSS_COMPILE)ar
NM		=  $(CROSS_COMPILE)nm
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE    ?= /home/m/kernel/toolchain/clang/host/linux-x86/clang-4639204/bin/aarch64-linux-gnu-
